...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $phone=$_POST['phone'];
        ...
        $statement = $pdo->prepare("UPDATE sp_users SET email = :email, password = :password, name = :name, state = :state, postalCode = :postalCode, adress = :adress, phone= :phone WHERE email = :email");
...
<body class="container">
    ...
    <form method="POST">
        ...
        <?php if ($user['state'] === 'Fill this data' || $user['adress'] === 'Fill this data' || $user['postalCode'] === '123' || $user['phone'] === '000000000000'): ?>
