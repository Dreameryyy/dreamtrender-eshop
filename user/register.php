...
if (!empty($_POST)) {
    ...
    if ($existingUser) {
        ...
        $statement = $pdo->prepare('INSERT INTO sp_users (email, name, password, privilege, adress, state, postalCode, phone) VALUES (:email, :name, :password, :privilege, :adress, :state, :postalCode, :phone)');
        $statement->execute(['email' => $email, 'name' => $name, 'password' => $hashed_password, 'privilege' => $privilege, 'adress' => $adress, 'state' => $state, 'postalCode' => $postalCode, 'phone'=> $phone]);
        ...
        <div class="col-md-12 d-flex justify-content-center">
            <div class="user-form">
                ...
                <form action="./register.php" method="POST">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" placeholder="Enter phone number" pattern="[0-9]+" title="Only numbers are allowed" name="phone" required>
                    </div>
